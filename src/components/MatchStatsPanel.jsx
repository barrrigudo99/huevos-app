...
export default function MatchStatsPanel({ matchId, players, currentUser, jugadoresGuardados, onSaved }) {
  ...
  return (
    <div className="stats-panel">
      ...
      <button type="button" className="btn-outline full-width" onClick={handleMarcarJugado} disabled={marking}>
        {marking ? 'Marcando...' : marked ? 'Partido marcado como jugado' : 'Marcar partido como jugado'}
      </button>
    </div>
  )
}
