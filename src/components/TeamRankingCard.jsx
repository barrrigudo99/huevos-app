...
// Pensado para móvil: se muestran los primeros VISIBLE_LIMIT jugadores del
// orden actual y el resto queda tras un botón "Ver los N restantes", para no
// obligar a un scroll largo dentro de StatsScreen.
  ...
  return (
    <div style={{ background: C.ink, border: `1px solid ${C.border}`, borderRadius: 16, padding: '18px 20px 8px', fontFamily: FONT_BODY }}>
      ...
      {hiddenCount > 0 && (
        ...
        >
          {showAll ? 'Ver menos' : `Ver los ${hiddenCount} restantes`}
        </button>
      )}
    </div>
  )
